const About = () => {
  return ( 
    <>
      <h1>About</h1>
      <h3>Hello and thank you for stopping by my portfolio page! My name is Justin Pastine. I love spending time with family, sports, outdoor activities and trying new things. I was born and raised in Denver, CO and just recently relocated near Atlanta, GA.
      </h3>
